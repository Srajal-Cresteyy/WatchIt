...
function NavBar({ user, onSearch, onLogin, onLogout }) {
  ...
  return (
    <div>
      <div className="navbar flex flex-col lg:flex-row container  mx-auto px-20 py-4 bg-white relative z-10">
        <div className="mx-5 mb-2 lg:mb-0">
          <a className="text-xl font-light border bg-white px-2 py-1" href="/">
            WatchIt
          </a>
        </div>
